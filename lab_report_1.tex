...
%		\includegraphics{distrib.png}
	...
	\begin{enumerate}[label=(\alph*)]
		\item Datasets are can be found in directory 
		\item Logistical regression is performed using scikit-learn's linearmodel.LogisticalRegression. Two things to note:
		\begin{itemize}
